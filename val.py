...
def parse_opt():
    ...
    parser.add_argument('--data', type=str, default=ROOT / 'data/ab.yaml', help='dataset.yaml path')
    parser.add_argument('--weights', nargs='+', type=str, default=ROOT / './weights/9257.pt', help='model.pt path(s)')
